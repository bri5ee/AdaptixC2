...
namespace {
struct qt_meta_stringdata_UploaderWorker_t {
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_UploaderWorker_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_UploaderWorker_t qt_meta_stringdata_UploaderWorker = {
    {
        QT_MOC_LITERAL(0, 14),  // "UploaderWorker"
        QT_MOC_LITERAL(15, 8),  // "progress"
        QT_MOC_LITERAL(24, 0),  // ""
        QT_MOC_LITERAL(25, 4),  // "sent"
        QT_MOC_LITERAL(30, 5),  // "total"
        QT_MOC_LITERAL(36, 12),  // "speedUpdated"
        QT_MOC_LITERAL(49, 4),  // "kbps"
        QT_MOC_LITERAL(54, 8),  // "finished"
        QT_MOC_LITERAL(63, 6),  // "failed"
        QT_MOC_LITERAL(70, 5),  // "error"
        QT_MOC_LITERAL(76, 5),  // "start"
        QT_MOC_LITERAL(82, 6),  // "cancel"
        QT_MOC_LITERAL(89, 10),  // "onProgress"
        QT_MOC_LITERAL(100, 10),  // "onFinished"
        QT_MOC_LITERAL(111, 7),  // "onError"
        QT_MOC_LITERAL(119, 27)   // "QNetworkReply::NetworkError"
    },
    "UploaderWorker",
    "progress",
    "",
...
Q_CONSTINIT static const uint qt_meta_data_UploaderWorker[] = {
...
Q_CONSTINIT const QMetaObject UploaderWorker::staticMetaObject = { {
    ...
    qt_meta_stringdata_UploaderWorker.offsetsAndSizes,
    qt_meta_data_UploaderWorker,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_UploaderWorker_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<UploaderWorker, std::true_type>,
        // method 'progress'
...
void UploaderWorker::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (UploaderWorker::*)(qint64 , qint64 );
            if (_t _q_method = &UploaderWorker::progress; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (UploaderWorker::*)(double );
            if (_t _q_method = &UploaderWorker::speedUpdated; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (UploaderWorker::*)();
            if (_t _q_method = &UploaderWorker::finished; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 2;
                return;
            }
        }
        {
            using _t = void (UploaderWorker::*)(const QString & );
            if (_t _q_method = &UploaderWorker::failed; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 3;
                return;
            }
        }
...
void *UploaderWorker::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_UploaderWorker.stringdata0))
