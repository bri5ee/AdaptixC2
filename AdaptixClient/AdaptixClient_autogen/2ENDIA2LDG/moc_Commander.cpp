...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_Commander_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_Commander_t qt_meta_stringdata_Commander = {
    {
        QT_MOC_LITERAL(0, 9),  // "Commander"
        QT_MOC_LITERAL(10, 15),  // "commandsUpdated"
        QT_MOC_LITERAL(26, 0)   // ""
    },
    "Commander",
    "commandsUpdated",
...
Q_CONSTINIT static const uint qt_meta_data_Commander[] = {
...
Q_CONSTINIT const QMetaObject Commander::staticMetaObject = { {
    ...
    qt_meta_stringdata_Commander.offsetsAndSizes,
...
void Commander::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &Commander::commandsUpdated; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
